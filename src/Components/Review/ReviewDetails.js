...
const ReviewDetails = ({ review }) => {
    console.log(review);
    return (        
        <div className="flex w-full mx-auto items-center h-24 my-10 rounded-lg  border-purple-400 ">
        <div className="flex bg-purple-800 p-4 rounded-lg">
          ...
          <div className="w-1/3">
            <img className="w-48  h-32 hover:animate-bounce p-1 rounded-lg" src={review.imageURL} alt="" />
          </div>
        </div>
      </div>
    );
